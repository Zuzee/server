...
class Toilet(models.Model):
    ...
    for_men = models.BooleanField(null=True, blank=True)
    for_women = models.BooleanField(null=True, blank=True)
    for_handicapped = models.BooleanField(null=True, blank=True)
